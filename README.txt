...
1. Install Java on your computer if it is not installed.
...
You can enter the admin window by entering the credentials "calin" for username and "parola" for password.
You can enter the user window by entering the credentials
"andrei" for username and "parola" for password.
...
If you want to create an Account, write the ID Card Nr Acc, Type of Account and Money.
If you want to update an Account, write the ID Card Nr Acc, Type of Account, Money and the Account ID.
